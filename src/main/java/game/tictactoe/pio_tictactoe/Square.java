...
class Square extends StackPane
{
	...
	final CustomCircle circle = new CustomCircle(GameInfo.CIRCLE_CENTER, GameInfo.CIRCLE_CENTER,
														 GameInfo.CIRCLE_RADIUS, GameInfo.CIRCLE_WIDTH);
	final Cross cross = new Cross(GameInfo.CROSS_WIDTH, GameInfo.CROSS_SIZE, GameInfo.CROSS_SIZE);
	final Cross crossCursor = new Cross(GameInfo.CROSS_CURSOR_WIDTH, GameInfo.CROSS_CURSOR_SIZE,
												GameInfo.CROSS_CURSOR_SIZE);
	final CustomCircle circleCursor = new CustomCircle(GameInfo.CIRCLE_CURSOR_CENTER,
